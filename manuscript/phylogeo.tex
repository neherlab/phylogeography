...
The computational resources necessary to infer such models increase rapidly with complexity, it becomes harder to understand how the data inform the inferences, and interpretation of inferred parameter values becomes ambiguous as they might have absorbed effects not explicitly modeled.
In absence of a good understanding of the dispersal properties past how population dynamics in time and space that defines model structure, simple approaches that allow transparent interpretation of how results are informed by features of the data are preferable to complex and computationally demanding models that can nevertheless fail to faithfully infer history or essential parameters.
